"""Incident Response Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Incident Response Agent through a multi-step pipeline.
